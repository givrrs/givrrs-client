export const errorInitializer = <T extends object = Record<string, boolean>>(
  initialLoadingState: T
) =>
...
const initializer = <T extends object = Record<string, boolean>, U = string>(
  initializingObj: T,
  initilizeWith: U
) =>
