  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          'bg-primary-500 text-primary-500-foreground hover:bg-primary-500 hover:text-primary-500-foreground focus:bg-primary-500 focus:text-primary-500-foreground rounded-l-md rounded-r-md',
