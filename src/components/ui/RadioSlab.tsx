...
const RadioSlabItem = ({ option }: { option: TRadioOption }) => {
  return (
    <RadioGroupItem
      key={option.value}
      value={option.value}
      className="ring-border flex w-full items-center justify-center gap-2 rounded-md p-3 ring-[1px] data-[state=checked]:bg-green-100 data-[state=checked]:ring-2 data-[state=checked]:ring-green-600"
    >
