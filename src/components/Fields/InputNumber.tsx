    ...
    return (
      <FormItem className="w-full">
        ...
        <FormControl className="w-full">
          <NumericFormat
            className="border-input placeholder:text-muted-foreground focus-visible:ring-ring flex h-11 w-full rounded-lg border bg-transparent px-3 py-1 text-sm transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
            {...{ ref }}
            {...restProps}
          />
        </FormControl>
